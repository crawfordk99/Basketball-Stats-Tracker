        ...
        while (continueLoop) {
            ...
            switch (userInput) {
                ...
                case "1":
                    ...
                    // Creates new file name for person to keep track of stats
                    fileName = ($"{person.FirstName}{person.LastName}.txt");
                    
                    // Writes in name of person
                ...
                case "3":
                    ...
                    // Separate 2pt and 3pt shot stats
                ...
                case "4":
                    ...
                    // Will add to record of wins and losses
                    Console.WriteLine("Please enter a number for win first, and then loss. 1 means true, 0 means false.");
